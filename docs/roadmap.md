...
This is where Latch is going, not what it does today. For the current state see the [README](../README.md); for how the shipped pieces work see [architecture](architecture.md).
...
### M1 — local Mac application (in progress)
