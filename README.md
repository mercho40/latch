...
- `AgentRuntimeRegistry` reserves stable Latch-local IDs, prevents duplicate launches, supervises multiple runtimes, evicts terminated processes, and supports individual or concurrent shutdown.
